...
if __name__ == '__main__':
    ...
    filename_input = 'bridge.png'
    filename_output = 'bridgeres.png'
    print("bicubic interpolation method")
    new_height = 300
    new_width = 600

    input_image = os.path.join(folder_in, "images", filename_input)
    output_image = os.path.join(folder_out, "bicubic_interpolation", filename_output)
